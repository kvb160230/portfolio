        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {projects.map((project, idx) => (
            <motion.div
              ...
              className="group relative p-6 rounded-2xl bg-neutral-900/50 border border-neutral-800 hover:border-neutral-700 hover:bg-neutral-900 transition-all flex flex-col"
            >
              ...
              <p className="text-neutral-400 mb-4 leading-relaxed grow">
                {project.description}
              </p>
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {project.tech.map((t) => (
                  <span
                    key={t}
                    className="text-xs font-mono px-2 py-1 rounded-md bg-neutral-950 text-neutral-400 border border-neutral-800"
                  >
                    {t}
                  </span>
                ))}
                ...
                <div className="flex gap-4 pt-2 border-t border-neutral-800">
                  {project.link && (
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 text-sm text-neutral-400 hover:text-indigo-300 transition-colors"
                    >
